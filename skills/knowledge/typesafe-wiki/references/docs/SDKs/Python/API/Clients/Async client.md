...
* **`http_client`** (`httpx2.[AsyncClient](https://pydantic.dev/docs/httpx2/api/api/#httpx2.AsyncClient) | None`, default: `None` ) –
...
Reached through [`AsyncTypeSafeClient.models`](Async client.md#typesafe_sdk.AsyncTypeSafeClient.models).

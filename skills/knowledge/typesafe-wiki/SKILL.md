---
name: typesafe-wiki
description: "TypeSafe AI（typesafe.ai）官方文档离线 Wiki，覆盖 Jev System One 模型、Choice/Score/Noul 问题原语、state 结构与置信度、架构 Patterns、Python/JavaScript SDK、HTTP API 参考与 Cookbooks 示例；用于查询 TypeSafe API/SDK 的接入、用法与示例。不用于其他 LLM 厂商 API、千问或百炼系列文档问题。"
---

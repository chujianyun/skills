# developers.llamaindex.ai/python/framework/community/integrations/guidance/index.md
> https://developers.llamaindex.ai/python/framework/community/integrations/guidance/index.md

--- title: Guidance | Developer Documentation ---
Guidance [1] is a guidance language for controlling large language models developed by Microsoft.
...
from llama\_index.core.prompts.guidance\_utils import convert\_to\_handlebars\` that can convert from the Python format string style template to guidance handlebars-style template.
...
# define guidance based question generator question_gen = GuidanceQuestionGenerator.from_defaults( guidance_llm=GuidanceOpenAI("text-davinci-003"), verbose=False )

# define query engine tools query_engine_tools = ...

# construct sub-question query engine s_engine = SubQuestionQueryEngine.from_defaults( question_gen=question_gen, # use guidance based question_gen defined above query_engine_tools=query_engine_tools, ) ```

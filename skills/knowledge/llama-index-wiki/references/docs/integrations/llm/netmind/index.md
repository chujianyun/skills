# developers.llamaindex.ai/python/framework/integrations/llm/netmind/index.md
> https://developers.llamaindex.ai/python/framework/integrations/llm/netmind/index.md

--- title: Netmind AI LLM | Developer Documentation ---

This notebook shows how to use `Netmind AI` as an LLM. Check out the full list of models netmind.ai [1].
...
``` # set api key in env or in llm # import os # os.environ["NETMIND_API_KEY"] = "your api key"

llm = NetmindLLM( model="meta-llama/Llama-3.3-70B-Instruct", api_key="<API_KEY>" ) ```

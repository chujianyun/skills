# developers.llamaindex.ai/python/framework/getting_started/installation/index.md
> https://developers.llamaindex.ai/python/framework/getting_started/installation/index.md

--- title: Installation and Setup | Developer Documentation ---
...
A complete list of packages and available integrations is available on LlamaHub [1].
## Quickstart Installation from Pip
To get started quickly, you can install with:

``` pip install llama-index ```
This is a starter bundle of packages, containing
- `llama-index-core` - `llama-index-llms-openai` - `llama-index-embeddings-openai` - `llama-index-readers-file`
...
- Install poetry [3] - this will help you manage package dependencies

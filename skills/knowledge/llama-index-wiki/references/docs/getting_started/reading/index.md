# developers.llamaindex.ai/python/framework/getting_started/reading/index.md
> https://developers.llamaindex.ai/python/framework/getting_started/reading/index.md

--- title: How to read these docs | Developer Documentation ---
...
## Before you start
LlamaIndex is a Python library, so you should have Python installed [1] and a basic working understanding of how to write it. If you prefer JavaScript, we recommend trying out our TypeScript package [2].
Many of our examples are formatted as Notebooks, by which we mean Jupyter-style notebooks. You don’t have to have Jupyter installed; you can try out most of our examples on a hosted service like [Google Colab] [3].
...
2. **Understand:** Once you’ve completed the Getting Started section, the Understanding section is the next place to go. In a series of bite-sized tutorials, we’ll walk you through every stage of building a production LlamaIndex application and help you level up on the concepts of the library and LLMs in general as you go.
...
5. **Component guides:** These are comprehensive, lower-level guides to the individual components of LlamaIndex and how to use them. Check them out.

[1] https://www.python.org/downloads/
[2] https://ts.llamaindex.ai/

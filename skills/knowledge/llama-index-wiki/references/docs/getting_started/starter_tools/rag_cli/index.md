# developers.llamaindex.ai/python/framework/getting_started/starter_tools/rag_cli/index.md
> https://developers.llamaindex.ai/python/framework/getting_started/starter_tools/rag_cli/index.md

--- title: RAG CLI | Developer Documentation ---
...
To bootstrap the application, make sure you have NodeJS and npx installed on your machine. If not, please refer to the LlamaIndex.TS [1] documentation for instructions.
...
It will call our `create-llama` tool, so you will need to provide several pieces of information to create the app. You can find more information about the `create-llama` on [npmjs - create-llama] [2]
Terminal window
``` ❯ llamaindex-cli rag --create-llama
...
## Customization
The `rag` CLI tool is highly customizable! The tool is powered by combining the `IngestionPipeline` module within the [`RagCLI`] [3] module.
...
``` #!/path/to/your/virtualenv/bin/python import os from llama_index.core.ingestion import IngestionPipeline, IngestionCache from llama_index.core.storage.docstore import SimpleDocumentStore from llama_index.cli.rag import RagCLI
...
Internally, the `rag` CLI tool uses the SimpleDirectoryReader to parse the raw files in your local filesystem into strings.
...
vec_store = ... # your vector store instance llm = ... # your LLM instance - optional, will default to OpenAI gpt-3.5-turbo
...
if __name__ == "__main__": rag_cli_instance.cli() ```
...
[1] https://ts.llamaindex.ai/docs/llamaindex/getting_started
[2] https://www.npmjs.com/package/create-llama#example
[3] https://github.com/run-llama/llama_index/blob/main/llama-index-cli/llama_index/cli/rag/base.py
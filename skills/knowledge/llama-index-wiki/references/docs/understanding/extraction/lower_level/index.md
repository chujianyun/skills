# developers.llamaindex.ai/python/framework/understanding/extraction/lower_level/index.md
> https://developers.llamaindex.ai/python/framework/understanding/extraction/lower_level/index.md

--- title: Low-level structured data extraction | Developer Documentation ---
...
# use your outputs print(outputs[0]) ```
...
# use your outputs print(outputs) ```

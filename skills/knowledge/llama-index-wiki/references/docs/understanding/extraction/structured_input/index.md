# developers.llamaindex.ai/python/framework/understanding/extraction/structured_input/index.md
> https://developers.llamaindex.ai/python/framework/understanding/extraction/structured_input/index.md

[Column 1]
--- title: Structured Input | Developer Documentation ---

## Using Structured Input Alone
Here is a simple example of how to use structured inputs with Pydantic models:
```` from pydantic import BaseModel from llama_index.core.prompts import RichPromptTemplate from llama_index.llms.openai import OpenAI from typing import Dict
...
LlamaIndex offers you the possibility of natively formatting your inputs as XML snippets, leveraging banks [1] and Jinja [2] (make sure to have `llama-index>=0.12.34` installed).
...
``` from pydantic import Field from typing import Optional
...
If you want a more in-depth guide to structured input, check out this example notebook [3].

[1] https://masci.github.io/banks
[2] https://jinja.palletsprojects.com/en/stable/
[3] https://docs.llamaindex.ai/en/latest/examples/prompts/structured_input
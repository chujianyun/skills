# developers.llamaindex.ai/python/framework/understanding/rag/index.md
> https://developers.llamaindex.ai/python/framework/understanding/rag/index.md

--- title: Introduction to RAG | Developer Documentation ---
Tip
...
- **Loading**: this refers to getting your data from where it lives — whether it’s text files, PDFs, another website, a database, or an API — into your workflow. LlamaHub [1] provides hundreds of connectors to choose from.

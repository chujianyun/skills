# developers.llamaindex.ai/python/framework/module_guides/loading/documents_and_nodes/index.md
> https://developers.llamaindex.ai/python/framework/module_guides/loading/documents_and_nodes/index.md

--- title: Documents / Nodes | Developer Documentation ---
## Concept
...
- `metadata` - a dictionary of annotations that can be appended to the text. - `relationships` - a dictionary containing relationships to other Documents/Nodes.
...
# load documents ...
# parse nodes parser = SentenceSplitter() nodes = parser.get_nodes_from_documents(documents)

# build index index = VectorStoreIndex(nodes) ```
### Document/Node Usage
Take a look at our in-depth guides for more details on how to use Documents/Nodes.
- Using Documents - Using Nodes - Ingestion Pipeline
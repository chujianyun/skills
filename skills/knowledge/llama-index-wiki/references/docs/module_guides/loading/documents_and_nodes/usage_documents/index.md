# developers.llamaindex.ai/python/framework/module_guides/loading/documents_and_nodes/usage_documents/index.md
> https://developers.llamaindex.ai/python/framework/module_guides/loading/documents_and_nodes/usage_documents/index.md

--- title: Defining and Customizing Documents | Developer Documentation ---
## Defining Documents
...
[Column 1]
# automatically sets the metadata of each document according to filename_fn documents = SimpleDirectoryReader( "./data", file_metadata=filename_fn ).load_data() ```
### Customizing the id
...
``` from llama_index.core import Document from llama_index.core.schema import MetadataMode

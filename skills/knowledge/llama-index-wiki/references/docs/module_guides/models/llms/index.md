# developers.llamaindex.ai/python/framework/module_guides/models/llms/index.md
> https://developers.llamaindex.ai/python/framework/module_guides/models/llms/index.md
...
- Support for **text completion** and **chat** endpoints (details below) - Support for **streaming** and **non-streaming** endpoints - Support for **synchronous** and **asynchronous** endpoints
## Usage Pattern
...
# changing the global default Settings.llm = OpenAI()

# local usage resp = OpenAI().complete("Paul Graham is ") print(resp)

# per-query/chat engine query_engine = index.as_query_engine(..., llm=llm) chat_engine = index.as_chat_engine(..., llm=llm) ```

Find more details on standalone usage or custom usage.
...
# huggingface from transformers import AutoTokenizer
...
## Further reading
- Embeddings - Prompts - Local LLMs - Running Llama2 Locally [1]

...
paths:
  /services/aigc/virtualmodel/generation:
    post:
      operationId: createVirtualModelTask
      summary: 创建虚拟模特任务
      description: 提交一个异步虚拟模特任务，该请求会返回任务ID。请使用任务ID轮询 GET /tasks/{task_id} 获取结果。
      parameters:
        - name: X-DashScope-Async
          in: header
          required: true
          description: 是否使用异步调用。HTTP只支持异步调用，设置为 `enable`。
          schema:
            type: string
            enum:
              - enable
      requestBody:
        ...
        content:
          application/json:
            schema:
              $ref: "#/components/schemas/VirtualModelRequest"
      responses:
        "200":
          description: 任务提交成功
          content:
            ...
            application/json:
              ...
              examples:
                ...
                InvalidFileContent:
                  ...
                  value:
                    request_id: a4d78a5f-655f-9639-8437-xxxxxx
                    code: InvalidFile.Content
                    message: The input image has no human body or has unclear human body. Please upload other image
        "401":
          description: 认证失败
          content:
            application/json:
      ...
      x-codeSamples:
        - lang: curl
          label: cURL（V1 — wanx-virtualmodel）
          source: |-

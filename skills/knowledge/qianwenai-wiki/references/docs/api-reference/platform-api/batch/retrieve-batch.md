...
paths:
  /batches/{batch_id}:
    get:
      ...
      summary: 查询批量任务详情
      description: 查询批量任务的状态，并在任务完成后获取输出文件 ID。
      parameters:
        - name: batch_id
          in: path
          required: true
          description: 要查询的批量任务 ID。
          schema:
            type: string
      ...
      x-codeSamples:
        ...
        - lang: curl
          label: cURL
          source: |-
            curl -X GET "https://dashscope.aliyuncs.com/compatible-mode/v1/batches/batch_abc123" \

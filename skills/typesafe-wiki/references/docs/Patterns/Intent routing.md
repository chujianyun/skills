...
Note the additional confidence check on the complexity score. As discussed in [Confidence](../Concepts/Confidence.md), it is always important to consider the meaning of a low confidence score in the context of the system and the stakes of the decision.

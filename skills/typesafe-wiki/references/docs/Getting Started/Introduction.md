...
* [Quick Start](Quick start.md) — Everything you need to get started immediately.
* [AI Primer](AI primer.md) — Why TypeSafe trains models for calibrated decisions instead of generated text.
* [Primitives (Questions)](../Primitives/Primitives (Questions).md) — How to define questions, choose between Choice, Score, and Noul, and ask several at once.
* [Confidence](../Concepts/Confidence.md) — How TypeSafe reports certainty, and how to use it architecturally.
* [Patterns](../Patterns/Patterns.md) — Common patterns for building systems with TypeSafe.

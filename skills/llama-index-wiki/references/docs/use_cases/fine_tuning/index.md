# developers.llamaindex.ai/python/framework/use_cases/fine_tuning/index.md
> https://developers.llamaindex.ai/python/framework/use_cases/fine_tuning/index.md
...
We then launch a finetuning job, and get back a distilled model. We can evaluate this model with Ragas [3] to benchmark against a naive GPT-3.5 flow.
...
- Fine-tune LLM Correctness Judge - Fine-tune LLM Judge

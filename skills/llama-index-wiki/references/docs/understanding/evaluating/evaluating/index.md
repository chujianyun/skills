# developers.llamaindex.ai/python/framework/understanding/evaluating/evaluating/index.md
> https://developers.llamaindex.ai/python/framework/understanding/evaluating/evaluating/index.md

--- title: Evaluating | Developer Documentation ---
Evaluation and benchmarking are crucial concepts in LLM development. To improve the performance of an LLM app (RAG, agents), you must have a way to measure it.
LlamaIndex offers key modules to measure the quality of generated results. We also offer key modules to measure retrieval quality. You can learn more about how evaluation works in LlamaIndex in our [module guides] (/python/framework/module_guides/evaluating/index.md).
## Response Evaluation

# developers.llamaindex.ai/python/framework/integrations/vector_stores/existing_data/weaviate_existing_data/index.md
> https://developers.llamaindex.ai/python/framework/integrations/vector_stores/existing_data/weaviate_existing_data/index.md

--- title: Guide: Using Vector Store Index with Existing Weaviate Vector Store | Developer Documentation ---
...
``` schema = { "classes": [ { "class": "Book", "properties": [ {"name": "title", "dataType": ["text"]}, {"name": "author", "dataType": ["text"]}, {"name": "content", "dataType": ["text"]}, {"name": "year", "dataType": ["int"]}, ], }, ] }

if not client.schema.contains(schema): client.schema.create(schema) ```
### Define sample data

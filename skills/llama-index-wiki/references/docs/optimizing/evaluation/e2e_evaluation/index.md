# developers.llamaindex.ai/python/framework/optimizing/evaluation/e2e_evaluation/index.md
> https://developers.llamaindex.ai/python/framework/optimizing/evaluation/e2e_evaluation/index.md

--- title: End-to-End Evaluation | Developer Documentation ---
...
- Batch Eval Runner - Correctness Eval - Faithfulness Eval - Guideline Eval - Pairwise Eval - Relevancy Eval - Semantic Similarity Eval
...
Examples of this in the more traditional ML domain include Giskard [1].
## Metrics Ensembling
...
1. Evaluating changes cheaply and quickly across a large dataset during the development stage. 2. Flagging outliers for further evaluation (GPT-4 / human alerting) during the production monitoring stage.
...
[1] https://docs.giskard.ai/en/latest/getting-started/quickstart.html
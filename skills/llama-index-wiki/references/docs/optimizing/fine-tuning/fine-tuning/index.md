# developers.llamaindex.ai/python/framework/optimizing/fine-tuning/fine-tuning/index.md
> https://developers.llamaindex.ai/python/framework/optimizing/fine-tuning/fine-tuning/index.md

--- title: Fine-tuning | Developer Documentation ---
## Overview
...
- Finetuning embeddings for better retrieval performance - Finetuning Llama 2 for better text-to-SQL - Finetuning gpt-3.5-turbo to distill gpt-4
...
1. Generating a synthetic question/answer dataset using LlamaIndex over any unstructured context. 2. Finetuning the model 3. Evaluating the model.
...
- Fine-tuning an Adapter - Embedding Fine-tuning Guide - Router Fine-tuning

- Embedding Fine-tuning Repo [1] - Embedding Fine-tuning Blog [2]
## Fine-tuning LLMs
...
We then launch a finetuning job, and get back a distilled model. We can evaluate this model with Ragas [3] to benchmark against a naive GPT-3.5 workflow.
- GPT-3.5 Fine-tuning Notebook (Colab) [4] - GPT-3.5 Fine-tuning Notebook (Notebook link) - \[WIP\] Function Calling Fine-tuning
**Old**
- GPT-3.5 Fine-tuning Notebook (Colab) [5] - GPT-3.5 Fine-tuning Notebook (in Repo) [6]
...
- Llama 2 Text-to-SQL Fine-tuning (w/ Modal, Repo) [7] - Llama 2 Text-to-SQL Fine-tuning (w/ Modal, Notebook) [8]
...
- Finetune Correctness Judge - Finetune LLM Judge
...
- Cross-Encoder Finetuning - Finetuning Llama 2 for Text-to-SQL [9] - Finetuning GPT-3.5 to Distill GPT-4 [5]
...
[1] https://github.com/run-llama/finetune-embedding
[2] https://medium.com/llamaindex-blog/fine-tuning-embeddings-for-rag-with-synthetic-data-e534409a3971
[3] https://github.com/explodinggradients/ragas
[4] https://colab.research.google.com/drive/1NgyCJVyrC2xcZ5lxt2frTU862v6eJHlc?usp=sharing
[5] https://colab.research.google.com/drive/1vWeJBXdFEObuihO7Z8ui2CAYkdHQORqo?usp=sharing
[6] https://github.com/jerryjliu/llama_index/blob/main/experimental/openai_fine_tuning/openai_fine_tuning.ipynb
[7] https://github.com/run-llama/modal_finetune_sql
[8] https://github.com/run-llama/modal_finetune_sql/blob/main/tutorial.ipynb
[9] https://medium.com/llamaindex-blog/easily-finetune-llama-2-for-your-text-to-sql-applications-ecd53640e10d
# developers.llamaindex.ai/python/framework/module_guides/evaluating/index.md
...
- **Dataset generation**: Given an unstructured text corpus, synthetically generate (question, context) pairs. - **Retrieval Evaluation**: Given a retriever and a set of questions, evaluate retrieved results using ranking metrics.
## Integrations
We also integrate with community evaluation tools.
- UpTrain [1] - Tonic Validate(Includes Web UI for visualizing results) - DeepEval [2] - Ragas [3] - RAGChecker [4] - Cleanlab

## Usage Pattern
For full usage details, see the usage pattern below.
- Query Eval Usage Pattern - Retrieval Eval Usage Pattern
## Modules
Notebooks with usage of these components can be found in the module guides.
...
[4] https://github.com/amazon-science/RAGChecker
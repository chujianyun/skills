# developers.llamaindex.ai/python/framework/module_guides/deploying/query_engine/streaming/index.md
> https://developers.llamaindex.ai/python/framework/module_guides/deploying/query_engine/streaming/index.md

--- title: Streaming | Developer Documentation ---
...
synth = get_response_synthesizer(streaming=True, ...) query_engine = RetrieverQueryEngine(response_synthesizer=synth, ...) ```
### Streaming Response
...
``` for text in streaming_response.response_gen: # do something with text as they arrive. pass ```
